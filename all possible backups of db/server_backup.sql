...
-- Started on 2024-05-21 00:46:07
...
ALTER ROLE administrator_role WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:K68iFbV1GN+QMkvN2FMbkg==$LwVGAxNceHRTFDn/Va04HNk5k/YV5Iec7RcVuKYlwqU=:25B++CWhuQv2WsnyrA0sVOz3Ihj5OUYaeQ1TK1au1oA=';
CREATE ROLE customer_role;
ALTER ROLE customer_role WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:3MYRd78X9SCPcLXo/VfvRw==$KZM5Xbsp6cTEuEtJHa0m2+rzEE/HQeXNX5CgPWfxWhI=:QMDwn5sr2D0a8AJB7j2q+04rJY/23WMuaVToCAzVEdE=';
CREATE ROLE developer_role;
ALTER ROLE developer_role WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:461Vmk3SNBIf76iit69gmA==$Y0123795eorEPnBRxCncWy+fME7X4rIQbxptxMezTDQ=:riXZ6ecYQewArAO/GlWyd4lDD0oHxIzl1ZLKf9PKx0A=';
CREATE ROLE postgres;
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:+Ji1WmxIr+Tm15xK0yoc3Q==$k4s7mfvYwhw23X0ocvNxxV1dvuTldnZfhbwqFCMkzaM=:o403SdpUzPIceq5xUW7u0MacsPu/SLQ3CXQBNIDKqT8=';
CREATE ROLE unregistered_role;
ALTER ROLE unregistered_role WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:C2/kFPBPOpDFFT4G4oSj+g==$XmE7BJwWTLmXRUlFXYUZTXoCl0VHu4sATDBOdNNDnI8=:BZfpv9mm30Qtv8kIup4UWqNkUu7w4iO8wWmoQJMh0KQ=';
...
-- Completed on 2024-05-21 00:46:07
...
--
-- TOC entry 4787 (class 1262 OID 41813)
-- Name: first_db; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE first_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Russian_Russia.1251';
...
--
-- TOC entry 216 (class 1259 OID 41820)
...
--
-- TOC entry 215 (class 1259 OID 41819)
...
--
-- TOC entry 4634 (class 2604 OID 41823)
...
--
-- TOC entry 4781 (class 0 OID 41820)
-- Dependencies: 216
-- Data for Name: person; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.person (id, name, age, email) FROM stdin;
1	Tom	24	tom@mail.ru
2	Bob	25	bob@mail.ru
3	Mike	26	mike@mail.ru
4	Katy	27	katy@mail.ru
5	Alexey	21	alexey2003petrov@yandex.ru
6	Andrew	20	woron20088@mail.ru
\.
...
--
-- TOC entry 4636 (class 2606 OID 41827)
...
-- Completed on 2024-05-21 00:46:08
...
-- Started on 2024-05-21 00:46:08
...
--
-- TOC entry 4681 (class 0 OID 16400)
-- Dependencies: 222
-- Data for Name: pga_jobagent; Type: TABLE DATA; Schema: pgagent; Owner: postgres
--

COPY pgagent.pga_jobagent (jagpid, jaglogintime, jagstation) FROM stdin;
6976	2024-05-16 13:25:29.171543+05	OSELISH-PC
\.


--
-- TOC entry 4682 (class 0 OID 16409)
-- Dependencies: 224
...
--
-- TOC entry 4683 (class 0 OID 16419)
-- Dependencies: 226
...
--
-- TOC entry 4685 (class 0 OID 16467)
-- Dependencies: 230
...
--
-- TOC entry 4686 (class 0 OID 16495)
-- Dependencies: 232
...
--
-- TOC entry 4687 (class 0 OID 16509)
-- Dependencies: 234
...
--
-- TOC entry 4684 (class 0 OID 16443)
-- Dependencies: 228
...
--
-- TOC entry 4688 (class 0 OID 16525)
-- Dependencies: 236
...
--
-- TOC entry 4889 (class 1262 OID 42604)
